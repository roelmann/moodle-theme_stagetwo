...
// Theme strings.
$string['choosereadme'] = 'stagetwo is a modern highly-customisable theme. This theme is intended to be used directly,
    or as a parent theme when creating new themes utilising Bootstrap 4.';
$string['configtitle'] = 'stagetwo';
$string['pluginname'] = 'stagetwo';
$string['region-side-pre'] = 'Right';
$string['region-side-main-top'] = 'Main-Top';
$string['region-side-main-bottom'] = 'Main-Bottom';
$string['region-side-main-right'] = 'Main-Right';
$string['region-side-main-left'] = 'Main-Left';
$string['region-side-alerts'] = 'Alerts';
...
$string['presetfiles_desc'] = 'Preset files can be used to dramatically alter the appearance of the theme.
    See https://docs.moodle.org/dev/stagetwo_Presets for information on creating and sharing your own preset files.';
